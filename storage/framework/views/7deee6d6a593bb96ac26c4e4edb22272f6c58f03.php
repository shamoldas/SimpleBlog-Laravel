...
<div class="container">
  <div class="row">
    <div class="col-sm-8">
        ...
        <ul class="list-group">
  <li class="list-group-item"><a href="<?php echo e(url('library')); ?>">Enrollment</a></li>

  
  <li class="list-group-item "><a href="<?php echo e(url('book')); ?>">Annul Fest</a></li>
...
<?php echo $__env->make('includes.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\school\resources\views/school/notices.blade.php ENDPATH**/ ?>