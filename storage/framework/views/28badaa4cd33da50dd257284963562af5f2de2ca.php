...
<section>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
             <center><h3 style="color: green;word-spacing: 2.5em;"><b><span style="text-decoration: line-through;">Hesitation</span> Feel Free <em style="font-size: 1.5em;">Contact</em></b></h3></center>
...
<section>
    ...
    <div class="row">
        <div class="col">
      <h4 style="margin-top:1em;font-family: Georgia, serif;text-decoration:underline;"><center>CONTACT FORM</center></h4>
    </div>
       </div>
    </div>
</section>
...
<div class="container">
  ...
  <form class="row g-3 needs-validation" novalidate method="post" action="<?php echo e(url('contact')); ?>">
     <?php echo e(csrf_field()); ?>

 
  <div class="col-md-6">
    <label for="validationCustom02" class="form-label">Your Name</label>
    <input type="text" name="name" class="form-control" id="validationCustom02" value="" placeholder="Enter Your Name" required="required">
  ...
  <div class="col-md-6">
    <label for="validationCustom03" class="form-label">City(Your Location)</label>
    <input type="text" name="location" class="form-control" id="validationCustom03" required>
    <div class="invalid-feedback">
  ...
  <div class="col-md-6">
    ...
    <select class="form-select"  name="subject" id="validationCustom04" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\school\resources\views/contact/create.blade.php ENDPATH**/ ?>